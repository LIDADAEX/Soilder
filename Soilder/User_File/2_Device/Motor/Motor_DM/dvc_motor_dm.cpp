 ...
 * @param __DJI_Motor_Driver_Version 大疆驱动版本, 当且仅当当前被分配电机为6020, 且是电流驱动新版本时选2023,
 * 否则都是default
 ...
 */
void Class_Motor_DM_Normal::Init(CAN_HandleTypeDef* hcan,
                                 uint8_t __CAN_Rx_ID,
                                 uint8_t __CAN_Tx_ID,
...
void Class_Motor_DM_Normal::Data_Process() {
    ...
    Struct_Motor_DM_CAN_Rx_Data_Normal* tmp_buffer =
        (Struct_Motor_DM_CAN_Rx_Data_Normal*)CAN_Manage_Object->Rx_Buffer.Data;
 ...
 */
void Class_Motor_DM_1_To_4::Init(CAN_HandleTypeDef* hcan,
...
void Class_Motor_DM_1_To_4::Data_Process() {
    ...
    Struct_Motor_DM_CAN_Rx_Data_1_To_4* tmp_buffer =
        (Struct_Motor_DM_CAN_Rx_Data_1_To_4*)CAN_Manage_Object->Rx_Buffer.Data;
