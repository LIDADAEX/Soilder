 ...
 * @param __DJI_Motor_Driver_Version 大疆驱动版本, 当且仅当当前被分配电机为6020,
 * 且是电流驱动新版本时选2023, 否则都是default
 * @return uint8_t* 缓冲区指针
 */
uint8_t* allocate_tx_data(
    CAN_HandleTypeDef* hcan,
    Enum_Motor_DJI_ID __CAN_ID,
    Enum_Motor_DJI_GM6020_Driver_Version __DJI_Motor_Driver_Version = Motor_DJI_GM6020_Driver_Version_DEFAULT) {
 ...
 * @param __Voltage_Max 最大速度, 需根据不同负载测量后赋值, 也就开环输出用得到,
 * 不过我感觉应该没有奇葩喜欢开环输出这玩意
 * @param __Current_Max 最大电流
 */
void Class_Motor_DJI_GM6020::Init(CAN_HandleTypeDef* hcan,
...
void Class_Motor_DJI_GM6020::Data_Process() {
    ...
    Rx_Data.Now_Power =
        power_calculate(Power_K_0, Power_K_1, Power_K_2, Power_A, Rx_Data.Now_Current, Rx_Data.Now_Omega);
 ...
 * @param __Current_Max 最大电流
 */
void Class_Motor_DJI_C610::Init(CAN_HandleTypeDef* hcan,
                                Enum_Motor_DJI_ID __CAN_Rx_ID,
                                Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method,
 ...
 * @param __Current_Max 最大电流
 */
void Class_Motor_DJI_C620::Init(CAN_HandleTypeDef* hcan,
                                Enum_Motor_DJI_ID __CAN_Rx_ID,
                                Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method,
                                float __Gearbox_Rate,
                                Enum_Motor_DJI_Power_Limit_Status __Power_Limit_Status,
...
void Class_Motor_DJI_C620::TIM_Calculate_PeriodElapsedCallback() {
    ...
    // 计算功率估计值
    Power_Estimate =
        power_calculate(Power_K_0, Power_K_1, Power_K_2, Power_A, Target_Current, Rx_Data.Now_Omega / Gearbox_Rate);
...
void Class_Motor_DJI_C620::Data_Process() {
    ...
    Rx_Data.Now_Power = power_calculate(
        Power_K_0, Power_K_1, Power_K_2, Power_A, Rx_Data.Now_Current, Rx_Data.Now_Omega * Gearbox_Rate);
