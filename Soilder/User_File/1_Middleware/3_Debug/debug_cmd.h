 ...
 */
static Class_Motor_DJI_C620* motor_list[] = {
    &motor_x_p,
    &motor_x_m,
    &motor_y_p,
    &motor_y_m
...
/** @brief 底盘子指令枚举 */
enum class EnumCmdChassisList : uint8_t {
    error = 0,
    get,
    put
};
...
static const char *PIDParamStrings[]     = {"p", "i", "d", "f", "i_limit", "out_limit", 
                                            "dead_zone", "speed_a", "speed_b", "separate"};
