...
void Class_FSM_Press_Hold::TIM_1ms_Calculate_PeriodElapsedCallback() {
    ...
    switch (Now_Status_Serial) {
        ...
        case (FSM_Press_Hold_Status_CLICK): {
            ...
            Se t_Status(FSM_Press_Hold_Status_FREE);
...
void Class_Robot::TIM_100ms_Calculate_Callback() {
    ...
    } else if (Referee.Get_Status() == Referee_Status_ENABLE &&
...
void Class_Robot::Referee_Draw_Static_UI() {
    // 底盘警戒线左
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_chassis_warning_left_line =
        Referee.Set_Referee_UI_Line(0, 0, Referee_Data_Interaction_Graphic_Color_ORANGE, 5, 400, 0, 660, 540);
    // 底盘警戒线右
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_chassis_warning_right_line =
        Referee.Set_Referee_UI_Line(0, 1, Referee_Data_Interaction_Graphic_Color_ORANGE, 5, 1550, 0, 1290, 540);
    // 弹道竖直线
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_booster_aiming_straight_line =
        Referee.Set_Referee_UI_Line(0, 2, Referee_Data_Interaction_Graphic_Color_MAIN, 2, 975, 350, 975, 500);
    // 近战准星直线
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_booster_near_line = Referee.Set_Referee_UI_Line(
        0, 3, Referee_Data_Interaction_Graphic_Color_MAIN, 2, 975 - 140, 400, 975 + 140, 400);
    // 中距离准星矩形
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_booster_middle_rectangle =
        Referee.Set_Referee_UI_Rectangle(0, 4, Referee_Data_Interaction_Graphic_Color_MAIN, 2, 960, 540, 990, 500);
    // 发送当前五个图形
    Referee.UART_Send_Interaction_UI_Graphic_5(graphic_chassis_warning_left_line,
                                               graphic_chassis_warning_right_line,
                                               graphic_booster_aiming_straight_line,
                                               graphic_booster_near_line,
                                               graphic_booster_middle_rectangle);
    // 准备发送下一组
    HAL_Delay(34);

    // 云台航向指示直线
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_gimbal_vision_line =
        Referee.Set_Referee_UI_Line(1, 0, Referee_Data_Interaction_Graphic_Color_MAIN, 4, 960, 100, 960, 150);
    // 裁判系统备用状态标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_status_circle = Referee.Set_Referee_UI_Circle(
        2, 1, Referee_Data_Interaction_Graphic_Color_WHITE, 5, 1440 + 7 / 2 + 15, 375, 15);
    // 裁判系统备用颜色标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_color_status_circle = Referee.Set_Referee_UI_Circle(
        2, 2, Referee_Data_Interaction_Graphic_Color_WHITE, 5, 1440 + 7 / 2 + 15 * 6, 375, 15);
    // 裁判系统备用底盘标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_chassis_status_circle =
        Referee.Set_Referee_UI_Circle(
            2, 3, Referee_Data_Interaction_Graphic_Color_WHITE, 5, 1440 + 7 / 2 + 15 * 11, 375, 15);
    // 裁判系统备用发射机构标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_booster_status_circle =
        Referee.Set_Referee_UI_Circle(
            2, 4, Referee_Data_Interaction_Graphic_Color_WHITE, 5, 1440 + 7 / 2 + 15 * 15, 375, 15);
    // 发送当前五个图形
    Referee.UART_Send_Interaction_UI_Graphic_5(graphic_gimbal_vision_line,
                                               graphic_referee_status_circle,
                                               graphic_referee_color_status_circle,
                                               graphic_referee_chassis_status_circle,
                                               graphic_referee_booster_status_circle);
    // 准备发送下一组
    HAL_Delay(34);

    // 裁判系统备用字符串
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_ref_color_chs_bst_lv_string =
        Referee.Set_Referee_UI_String(2, 0, Referee_Data_Interaction_Graphic_Color_ORANGE, 3, 1440, 350, 15, 30);
    // 发送当前字符串
...
void Class_Robot::Referee_Draw_Dynamic_UI() {
    ...
    if (Supercap_Accelerate_Status == true && Supercap_Burst_Mode_Status == true) {
        graphic_chassis_speed_mode_string =
            Referee.Set_Referee_UI_String(3, 0, Referee_Data_Interaction_Graphic_Color_GREEN, 6, 1680, 640, 40, 30);
        ...
        graphic_chassis_speed_mode_string =
            Referee.Set_Referee_UI_String(3, 0, Referee_Data_Interaction_Graphic_Color_ORANGE, 4, 1680, 640, 40, 30);
    ...
    if (Chassis_Gyroscope_Mode_Status == Robot_Gyroscope_Type_CLOCKWISE ||
        ...
        // 小陀螺特殊模式
        graphic_chassis_posture_mode_string =
            Referee.Set_Referee_UI_String(3, 1, Referee_Data_Interaction_Graphic_Color_GREEN, 6, 1680, 560, 40, 30);
        Referee.UART_Send_Interaction_UI_Graphic_String(graphic_chassis_posture_mode_string, "gyro");
    } else {
        // 否则底盘跟随
        graphic_chassis_posture_mode_string =
            Referee.Set_Referee_UI_String(3, 1, Referee_Data_Interaction_Graphic_Color_ORANGE, 4, 1680, 560, 40, 30);
    ...
    if (Manifold_Aiming_Priority == Manifold_Aiming_Priority_RUNE) {
        // 能量机关特殊模式
        graphic_autoaiming_mode_string =
            Referee.Set_Referee_UI_String(7, 1, Referee_Data_Interaction_Graphic_Color_GREEN, 6, 1680, 480, 40, 30);
        Referee.UART_Send_Interaction_UI_Graphic_String(graphic_autoaiming_mode_string, "rune");
    } else {
        // 否则装甲板
        graphic_autoaiming_mode_string =
            Referee.Set_Referee_UI_String(7, 1, Referee_Data_Interaction_Graphic_Color_ORANGE, 4, 1680, 480, 40, 30);
    ...
    for (int i = 0; i < 4; i++) {
        // 底盘掉线
        if (Chassis.Motor_Steer[i].Get_Status() == Motor_DJI_Status_DISABLE ||
            Chassis.Motor_Wheel[i].Get_Status() == Motor_DJI_Status_DISABLE) {
    ...
    if (tmp_chassis_alive_flag == false) {
        // 底盘掉线
        graphic_chassis_power_integer = Referee.Set_Referee_UI_Integer(3,
                                                                       2,
                                                                       ...
                                                                       750,
                                                                       50,
                                                                       Referee.Get_Self_Chassis_Power_Max());
    } else {
        // 底盘在线
        graphic_chassis_power_integer = Referee.Set_Referee_UI_Integer(
            3, 2, Referee_Data_Interaction_Graphic_Color_GREEN, 5, 1720, 750, 50, Referee.Get_Self_Chassis_Power_Max());
    }
    // 底盘方向指示
    ...
    graphic_chassis_status_line_front = Referee.Set_Referee_UI_Line(3,
                                                                    3,
    ...
    graphic_chassis_status_line_back = Referee.Set_Referee_UI_Line(3,
                                                                   4,
                                                                   Referee_Data_Interaction_Graphic_Color_MAIN,
                                                                   3,
                                                                   uint32_t(960 - tmp_x),
                                                                   uint32_t(100 - tmp_y),
                                                                   uint32_t(960 + tmp_y),
    ...
    graphic_chassis_status_line_left = Referee.Set_Referee_UI_Line(3,
                                                                   5,
                                                                   Referee_Data_Interaction_Graphic_Color_WHITE,
                                                                   3,
                                                                   uint32_t(960 - tmp_x),
    ...
    graphic_chassis_status_line_right = Referee.Set_Referee_UI_Line(3,
                                                                    6,
                                                                    Referee_Data_Interaction_Graphic_Color_WHITE,
                                                                    3,
                                                                    uint32_t(960 + tmp_x),
                                                                    ...
                                                                    uint32_t(960 + tmp_y),
                                                                    uint32_t(100 - tmp_x));
    Referee.UART_Send_Interaction_UI_Graphic_5(graphic_chassis_power_integer,
                                               graphic_chassis_status_line_front,
                                               graphic_chassis_status_line_back,
                                               graphic_chassis_status_line_left,
                                               graphic_chassis_status_line_right);
    HAL_Delay(34);
    ...
    if (Referee.Get_Status() == Referee_Status_DISABLE ||
        Referee.Get_Referee_Trust_Status() == Referee_Data_Status_DISABLE) {
        // 裁判系统踢出
        graphic_referee_status_circle = Referee.Set_Referee_UI_Circle(
            5, 0, Referee_Data_Interaction_Graphic_Color_BLACK, 15, 1440 + 7 / 2 + 15, 375, 7);
    } else {
        // 裁判系统在线
        graphic_referee_status_circle = Referee.Set_Referee_UI_Circle(
            5, 0, Referee_Data_Interaction_Graphic_Color_MAIN, 15, 1440 + 7 / 2 + 15, 375, 7);
    }
    // 裁判系统备用颜色标记圆
    ...
    if (Manifold_Self_Color == Manifold_Enemy_Color_RED) {
        // 自家设定红色
        graphic_referee_color_status_circle = Referee.Set_Referee_UI_Circle(
            5, 1, Referee_Data_Interaction_Graphic_Color_PINK, 15, 1440 + 7 / 2 + 15 * 6, 375, 7);
    } else if (Manifold_Self_Color == Manifold_Enemy_Color_BLUE) {
        // 自家设定蓝色
        graphic_referee_color_status_circle = Referee.Set_Referee_UI_Circle(
            5, 1, Referee_Data_Interaction_Graphic_Color_CYAN, 15, 1440 + 7 / 2 + 15 * 6, 375, 7);
    }
    // 裁判系统备用底盘标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_chassis_status_circle;
    if (Robot_Chassis_Type == Robot_Chassis_Type_HP) {
        // 血量优先
        graphic_referee_chassis_status_circle = Referee.Set_Referee_UI_Circle(
            5, 2, Referee_Data_Interaction_Graphic_Color_CYAN, 15, 1440 + 7 / 2 + 15 * 11, 375, 7);
    } else if (Robot_Chassis_Type == Robot_Chassis_Type_POWER) {
        // 功率优先
        graphic_referee_chassis_status_circle = Referee.Set_Referee_UI_Circle(
            5, 2, Referee_Data_Interaction_Graphic_Color_PINK, 15, 1440 + 7 / 2 + 15 * 11, 375, 7);
    }
    // 裁判系统备用发射机构标记圆
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_booster_status_circle;
    if (Robot_Booster_Type == Robot_Booster_Type_CD) {
        // 冷却优先
        graphic_referee_booster_status_circle = Referee.Set_Referee_UI_Circle(
            5, 3, Referee_Data_Interaction_Graphic_Color_CYAN, 15, 1440 + 7 / 2 + 15 * 15, 375, 7);
    } else if (Robot_Booster_Type == Robot_Booster_Type_BURST) {
        // 爆发优先
        graphic_referee_booster_status_circle = Referee.Set_Referee_UI_Circle(
            5, 3, Referee_Data_Interaction_Graphic_Color_PINK, 15, 1440 + 7 / 2 + 15 * 15, 375, 7);
    }
    // 裁判系统备用等级整数
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_referee_level_status_integer =
        Referee.Set_Referee_UI_Integer(
            5, 4, Referee_Data_Interaction_Graphic_Color_GREEN, 3, 1440 + 15 * 18, 375, 15, Robot_Level);
    Referee.UART_Send_Interaction_UI_Graphic_5(graphic_referee_status_circle,
                                               graphic_referee_color_status_circle,
                                               graphic_referee_chassis_status_circle,
                                               graphic_referee_booster_status_circle,
                                               graphic_referee_level_status_integer);
    // 准备发送下一组
    HAL_Delay(34);
    ...
    if (Supercap_Enable == false) {
        // 操作手踢出超级电容
        graphic_supercap_working_status_rectangle = Referee.Set_Referee_UI_Rectangle(
            6, 0, Referee_Data_Interaction_Graphic_Color_BLACK, 10, 760, 210, 760 + 1900 / 5, 180);
    } else if (Supercap.Get_Status() == false) {
        // 超级电容掉线
        graphic_supercap_working_status_rectangle = Referee.Set_Referee_UI_Rectangle(
            6, 0, Referee_Data_Interaction_Graphic_Color_PURPLE, 10, 760, 210, 760 + 1900 / 5, 180);
    } else if (Supercap_Accelerate_Status == true) {
        if (Supercap_Burst_Mode_Status == false) {
            // 加速模式
            graphic_supercap_working_status_rectangle = Referee.Set_Referee_UI_Rectangle(
                6, 0, Referee_Data_Interaction_Graphic_Color_YELLOW, 10, 760, 210, 760 + 1900 / 5, 180);
        } else if (Supercap_Burst_Mode_Status == true) {
            // 爆发模式
            graphic_supercap_working_status_rectangle = Referee.Set_Referee_UI_Rectangle(
                6, 0, Referee_Data_Interaction_Graphic_Color_ORANGE, 10, 760, 210, 760 + 1900 / 5, 180);
        }
    } else {
        // 常规工作模式
        graphic_supercap_working_status_rectangle = Referee.Set_Referee_UI_Rectangle(
            6, 0, Referee_Data_Interaction_Graphic_Color_WHITE, 10, 760, 210, 760 + 1900 / 5, 180);
    }
    // 超级电容能量矩形
    ...
    if (Supercap.Get_Energy_Status() == Supercap_24_Energy_Status_NORMAL) {
        // 正常电量
        graphic_supercap_energy_rectangle = Referee.Set_Referee_UI_Rectangle(
            6, 1, Referee_Data_Interaction_Graphic_Color_GREEN, 20, 765, 195, 765 + Supercap.Get_Now_Energy() / 5, 195);
    } else if (Supercap.Get_Energy_Status() == Supercap_24_Energy_Status_WARNING) {
        // 警告电量
        graphic_supercap_energy_rectangle =
            Referee.Set_Referee_UI_Rectangle(6,
                                             1,
                                             Referee_Data_Interaction_Graphic_Color_YELLOW,
                                             20,
                                             765,
                                             195,
                                             765 + Supercap.Get_Now_Energy() / 5,
                                             195);
    } else {
        // 低电量
        graphic_supercap_energy_rectangle =
    ...
    Referee.UART_Send_Interaction_UI_Graphic_2(graphic_supercap_working_status_rectangle,
                                               graphic_supercap_energy_rectangle);
    // 准备发送下一组
    HAL_Delay(34);
    ...
    if (Supercap.Get_Energy_Status() == Supercap_24_Energy_Status_NORMAL) {
        // 正常电量
        graphic_supercap_energy_integer = Referee.Set_Referee_UI_Integer(
            6, 2, Referee_Data_Interaction_Graphic_Color_GREEN, 3, 765, 155, 30, Supercap.Get_Now_Energy());
    } else if (Supercap.Get_Energy_Status() == Supercap_24_Energy_Status_WARNING) {
        // 警告电量
        graphic_supercap_energy_integer = Referee.Set_Referee_UI_Integer(
            6, 2, Referee_Data_Interaction_Graphic_Color_YELLOW, 3, 765, 155, 30, Supercap.Get_Now_Energy());
    } else {
        // 低电量
        graphic_supercap_energy_integer = Referee.Set_Referee_UI_Integer(
            6, 2, Referee_Data_Interaction_Graphic_Color_PURPLE, 3, 765, 155, 30, Supercap.Get_Now_Energy());
    }
    // 云台灯条yaw角圆弧

    // 云台Pitch角浮点数
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_pitch_float;
    if (Gimbal.Motor_Yaw.Get_Status() == Motor_DJI_Status_DISABLE ||
        Gimbal.Motor_Pitch.Get_Status() == Motor_DJI_Status_DISABLE) {
        // 云台掉线
        graphic_pitch_float = Referee.Set_Referee_UI_Float(4,
                                                           1,
                                                           Referee_Data_Interaction_Graphic_Color_PURPLE,
                                                           5,
                                                           50,
                                                           780,
                                                           40,
                                                           Gimbal.Get_Now_Pitch_Angle() / DEG_TO_RAD);
    } else {
        // 云台在线
        graphic_pitch_float = Referee.Set_Referee_UI_Float(4,
                                                           1,
    ...
    if (Manifold.Get_Status() == Manifold_Status_DISABLE) {
        // 自瞄掉线
        graphic_autoaiming_range_rectangle = Referee.Set_Referee_UI_Rectangle(
            7, 0, Referee_Data_Interaction_Graphic_Color_PURPLE, 1, 700, 340, 1200, 750);
        ...
        if (Manifold_Autoaiming_Status == false) {
            // 抓到目标但未跟随
            graphic_autoaiming_range_rectangle = Referee.Set_Referee_UI_Rectangle(
                7, 0, Referee_Data_Interaction_Graphic_Color_YELLOW, 3, 700, 340, 1200, 750);
        } else {
            // 抓到且跟随目标
            graphic_autoaiming_range_rectangle = Referee.Set_Referee_UI_Rectangle(
                7, 0, Referee_Data_Interaction_Graphic_Color_GREEN, 3, 700, 340, 1200, 750);
        }
    } else {
        // 未抓到目标
        graphic_autoaiming_range_rectangle = Referee.Set_Referee_UI_Rectangle(
            7, 0, Referee_Data_Interaction_Graphic_Color_WHITE, 1, 700, 340, 1200, 750);
    }
    // 摩擦轮转速整型
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_friction_omega_integer;
    if (Booster.Motor_Friction_Right.Get_Status() == Motor_DJI_Status_DISABLE ||
        Booster.Motor_Friction_Left.Get_Status() == Motor_DJI_Status_DISABLE ||
        Booster.Motor_Driver.Get_Status() == Motor_DJI_Status_DISABLE) {
        // 发射机构掉线
        graphic_friction_omega_integer = Referee.Set_Referee_UI_Integer(
            8, 0, Referee_Data_Interaction_Graphic_Color_PURPLE, 5, 50, 850, 50, Booster.Get_Friction_Omega());
    } else if (FSM_Heat_Detector.Get_Now_Status_Serial() == FSM_Heat_Detector_Status_CLOSE) {
        // 发射机构在线但未启用
        graphic_friction_omega_integer = Referee.Set_Referee_UI_Integer(
            8, 0, Referee_Data_Interaction_Graphic_Color_WHITE, 5, 50, 850, 50, Booster.Get_Friction_Omega());
    } else {
        // 发射机构启用
        graphic_friction_omega_integer = Referee.Set_Referee_UI_Integer(
            8, 0, Referee_Data_Interaction_Graphic_Color_GREEN, 5, 50, 850, 50, Booster.Get_Friction_Omega());
    }
    Referee.UART_Send_Interaction_UI_Graphic_5(graphic_supercap_energy_integer,
                                               graphic_pitch_float,
                                               graphic_pitch_float,
                                               graphic_autoaiming_range_rectangle,
                                               graphic_friction_omega_integer);
    // 准备发送下一组
    HAL_Delay(34);

    // 系统警告信息
    Struct_Referee_Data_Interaction_Graphic_Config* graphic_competition_warning = Referee.Set_Referee_UI_String(
        9, 0, Referee_Data_Interaction_Graphic_Color_ORANGE, 4, 960 - 14 * 30 - 20, 800, 30, 30);
    // 发送当前字符串
...
void Class_Robot::_Status_Control() {
    ...
    if (DR16.Get_Status() == DR16_Status_DISABLE || DR16.Get_Left_Switch() == DR16_Switch_Status_DOWN) {
        ...
        if (DR16.Get_Keyboard_Key_Ctrl() == DR16_Key_Status_FREE) {
            ...
            if (DR16.Get_Keyboard_Key_Q() == DR16_Key_Status_TRIG_PRESSED_FREE ||
                DR16.Get_Keyboard_Key_E() == DR16_Key_Status_TRIG_PRESSED_FREE) {
            ...
            if (DR16.Get_Keyboard_Key_V() == DR16_Key_Status_TRIG_FREE_PRESSED) {
                if (Manifold_Aiming_Priority == Manifold_Aiming_Priority_RUNE) {
                    ...
                    FSM_DR16_Left_Mouse_Press_Hold.Set_Hold_Time_Threshold(
                        FSM_DR16_Left_Mouse_Press_Hold.Get_Default_Hold_Time_Threshold());
                } else {
    ...
    if (Referee.Get_Status() == Referee_Status_ENABLE &&
        Referee.Get_Referee_Trust_Status() == Referee_Data_Status_ENABLE) {
        if (Referee.Get_Self_ID() == Referee_Data_Robots_ID_RED_INFANTRY_3 ||
            Referee.Get_Self_ID() == Referee_Data_Robots_ID_RED_INFANTRY_4 ||
            Referee.Get_Self_ID() == Referee_Data_Robots_ID_RED_INFANTRY_5) {
            Manifold_Self_Color = Manifold_Enemy_Color_RED;
        } else if (Referee.Get_Self_ID() == Referee_Data_Robots_ID_BLUE_INFANTRY_3 ||
                   Referee.Get_Self_ID() == Referee_Data_Robots_ID_BLUE_INFANTRY_4 ||
                   Referee.Get_Self_ID() == Referee_Data_Robots_ID_BLUE_INFANTRY_5) {
            Manifold_Self_Color = Manifold_Enemy_Color_BLUE;
        }
...
void Class_Robot::_Supercap_Control() {
    ...
    if (DR16.Get_Status() == DR16_Status_DISABLE || DR16.Get_Left_Switch() == DR16_Switch_Status_DOWN) {
        ...
        Supercap_Auto_Restart_Flag = false;
        tmp_status = Supercap_24_Data_Status_DISABLE;
    } else if (Gimbal.Motor_Yaw.Get_Status() == Motor_DJI_Status_DISABLE &&
               Gimbal.Motor_Pitch.Get_Status() == Motor_DJI_Status_DISABLE) {
        // 云台掉电则失能超级电容
        Supercap_Auto_Restart_Flag = false;
        tmp_status = Supercap_24_Data_Status_DISABLE;
               ...
               Referee.Get_Referee_Trust_Status() == Referee_Data_Status_ENABLE &&
               Referee.Get_Self_PM01_Chassis_Status() == Referee_Data_Status_DISABLE) {
        // 底盘裁判系统掉电则失能超级电容
        Supercap_Auto_Restart_Flag = false;
        tmp_status = Supercap_24_Data_Status_DISABLE;
    } else {
        ...
        if (Referee.Get_Chassis_Energy_Buffer() <= Restrict_Enable_Buffer_Energy) {
            ...
            tmp_status = Supercap_24_Data_Status_DISABLE;
        } else if (Referee.Get_Chassis_Energy_Buffer() >= Restrict_Disable_Buffer_Energy &&
                   Supercap_Auto_Restart_Flag == true) {
...
void Class_Robot::_Chassis_Control() {
    ...
    if (DR16.Get_Status() == DR16_Status_DISABLE || DR16.Get_Left_Switch() == DR16_Switch_Status_DOWN) {
        ...
        7
            // 底盘速度期望值
            float tmp_expect_direction_velocity_x,
            tmp_expect_direction_velocity_y, tmp_expect_direction_omega;
        // 底盘速度经过斜坡函数的值
        ...
        if (Posture.AHRS_Chassis.Get_Status() == AHRS_WHEELTEC_Status_ENABLE) {
            cos_yaw_feedforward =
                arm_cos_f32(Gimbal.Get_Now_Yaw_Angle() - Posture.Get_Chassis_Omega() * AHRS_Chassis_Omega_Feedforward);
            sin_yaw_feedforward =
                arm_sin_f32(Gimbal.Get_Now_Yaw_Angle() - Posture.Get_Chassis_Omega() * AHRS_Chassis_Omega_Feedforward);
        } else {
            cos_yaw_feedforward =
                arm_cos_f32(Gimbal.Get_Now_Yaw_Angle() - Posture.Get_Chassis_Omega() * Chassis_Omega_Feedforward);
            sin_yaw_feedforward =
                arm_sin_f32(Gimbal.Get_Now_Yaw_Angle() - Posture.Get_Chassis_Omega() * Chassis_Omega_Feedforward);
        }
        // 确保第一人称直线, 乘上旋转矩阵
        tmp_chassis_velocity_x = tmp_planning_chassis_velocity_x * cos_yaw_feedforward +
                                 tmp_planning_chassis_velocity_y * (-sin_yaw_feedforward);
        tmp_chassis_velocity_y = tmp_planning_chassis_velocity_x * sin_yaw_feedforward +
                                 tmp_planning_chassis_velocity_y * cos_yaw_feedforward;
...
void Class_Robot::_Gimbal_Control() {
    ...
    if (DR16.Get_Status() == DR16_Status_DISABLE || DR16.Get_Left_Switch() == DR16_Switch_Status_DOWN) {
        ...
        if (Manifold_Autoaiming_Status == true && Manifold.Get_Status() == Manifold_Status_ENABLE) {
            if (Timer_Switch_Target.Get_Now_Status() == Timer_Status_RESET ||
                Timer_Switch_Target.Get_Now_Status() == Timer_Status_WAIT) {
                tmp_gimbal_yaw = Manifold.Get_Target_Gimbal_Yaw() -
                                 Posture.Get_Chassis_Omega() * Autoaiming_Chassis_Omega_Feedforward;
        ...
        // 重力补偿拟合
        // tmp_gimbal_pitch_feedforward_current += -0.4643f * Posture.Get_Gimbal_Odom_Angle_Pitch() *
        // Posture.Get_Gimbal_Odom_Angle_Pitch() * Posture.Get_Gimbal_Odom_Angle_Pitch() - 0.254f *
        // Posture.Get_Gimbal_Odom_Angle_Pitch() * Posture.Get_Gimbal_Odom_Angle_Pitch() + 0.8796f *
        // Posture.Get_Gimbal_Odom_Angle_Pitch() + 0.3594f;

        if ((Manifold_Autoaiming_Status == true && Manifold.Get_Status() == Manifold_Status_ENABLE &&
             Manifold.Get_Enemy_ID() != Manifold_Enemy_ID_NONE_0) ||
            Timer_Turn_About.Get_Now_Status() == Timer_Status_WAIT) {
...
void Class_Robot::_Booster_Control() {
    ...
    if (DR16.Get_Status() == DR16_Status_DISABLE || DR16.Get_Left_Switch() == DR16_Switch_Status_DOWN) {
        ...
        if (DR16.Get_Keyboard_Key_Ctrl() == DR16_Key_Status_FREE) {
            ...
            // 发射逻辑控制
            if (Manifold_Autoaiming_Status == false || Manifold.Get_Status() == Manifold_Status_DISABLE ||
                (Manifold_Autoaiming_Status == true && (Timer_Switch_Target.Get_Now_Status() == Timer_Status_RESET ||
                                                        Timer_Switch_Target.Get_Now_Status() == Timer_Status_WAIT))) {
                if (DR16.Get_Right_Switch() == DR16_Switch_Status_TRIG_MIDDLE_UP ||
                    DR16.Get_Mouse_Left_Key() == DR16_Key_Status_TRIG_FREE_PRESSED) {
                    // 单发逻辑
                    Booster.Set_Booster_Control_Type(Booster_Control_Type_SPOT);
                } else if (DR16.Get_Right_Switch() == DR16_Switch_Status_TRIG_MIDDLE_DOWN ||
                           FSM_DR16_Left_Mouse_Press_Hold.Get_Now_Status_Serial() == FSM_Press_Hold_Status_HOLD) {
                    // 连发逻辑
                    ...
                    if (Referee.Get_Status() == Referee_Status_ENABLE &&
                        ...
                        Booster.Set_Max_Ammo_Shoot_Frequency(15.0f);
                           ...
                           FSM_DR16_Left_Mouse_Press_Hold.Get_Now_Status_Serial() == FSM_Press_Hold_Status_FREE) {
                    // 连发暂停
